...
preprocess_pipeline = ColumnTransformer(
    ...
    remainder="passthrough",  # 기본값은 drop, 남기기위해 작성
    verbose_feature_names_out=False,  # True로 바꾸면 이름_컬럼명 으로 나오므로 False 처리
)
preprocess_pipeline.set_output(transform="pandas")  # 디폴트는 numpy
